The following files have been curated from the Geonames database (latest as of April 2014).

To import these data sources into your MySQL server, follow the steps outlined below.
...
To import them into your MySQL server, use the following commands
